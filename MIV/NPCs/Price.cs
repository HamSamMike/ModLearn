...
{//这是一个NPC
    ...
    public class Price:ModNPC
    {
        ...
        public override void AddShops()
        {
            ...
            .Add(new Item(ModContent.ItemType<Items.ASD>()) { shopCustomPrice = Item.buyPrice(copper: 15) })//卖模组物品
            .Add(new Item(ModContent.ItemType<Items.Apex>()) { shopCustomPrice = Item.buyPrice(copper: 15) })
            .Add(new Item(ModContent.ItemType<Items.Minigun>()) { shopCustomPrice = Item.buyPrice(copper: 15) })
            .Add(new Item(ModContent.ItemType<Items.Accessory>()) { shopCustomPrice = Item.buyPrice(copper: 15) })
