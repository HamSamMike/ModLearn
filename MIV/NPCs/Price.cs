...
{//这是一个NPC
    ...
    public class Price:ModNPC
    {
        ...
        public override void AddShops()
        {
            ...
            .Add(new Item(ModContent.ItemType<Items.Weapon.Melee.DemonMetalSword>()) { shopCustomPrice = Item.buyPrice(copper: 15) })//卖模组物品
            .Add(new Item(ModContent.ItemType<Items.Tool.DemonHammer>()) { shopCustomPrice = Item.buyPrice(copper: 15) })
            .Add(new Item(ModContent.ItemType<Items.Weapon.Ranged.Bow.DemonMetalBow>()) { shopCustomPrice = Item.buyPrice(copper: 15) })
